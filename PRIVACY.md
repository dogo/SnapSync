...
MarvelSnap.pro receives the data required for account linking, synchronization, and card artwork delivery and applies its own privacy practices. SnapSync does not share this data with any other destination.
